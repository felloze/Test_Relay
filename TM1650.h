...
class TM1650
{
  ...
  void ack(void);                 //ACK function
	...
	void displayChar(uint8_t Bit, char ch);   //display character: 0-9 A b C d E F H L - blank
	void displaySeg(uint8_t Bit, uint8_t segCode); //display raw segment pattern
  ...
  void displayDot(uint8_t Bit, bool OnOff);
